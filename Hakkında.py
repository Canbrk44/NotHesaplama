...
class Ui_Hakknda(object):
    def setupUi(self, Hakknda):
        Hakknda.setObjectName("Hakknda")
        Hakknda.resize(640, 555)
        Hakknda.setStyleSheet("QProgressBar:horizontal {\n"
...
"}")
        self.label = QtWidgets.QLabel(Hakknda)
        self.label.setGeometry(QtCore.QRect(20, 20, 601, 221))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("../Pinterest Kblyigit.jpg"))
        self.label.setScaledContents(True)
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(Hakknda)
        self.label_2.setGeometry(QtCore.QRect(30, 320, 591, 111))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")

        self.retranslateUi(Hakknda)
        QtCore.QMetaObject.connectSlotsByName(Hakknda)

    def retranslateUi(self, Hakknda):
        _translate = QtCore.QCoreApplication.translate
        Hakknda.setWindowTitle(_translate("Hakknda", "Hakkında"))
        self.label_2.setText(_translate("Hakknda", "Bu Program Can Burak Dönmez Tarafında Geliştirlmek Üzere Tasarlanmıştır ve Her Hakkı Sakldır 2022"))
